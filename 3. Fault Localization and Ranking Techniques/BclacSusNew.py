...
def init(init_path, mutant_path, mutant_result_path, vid, pid, susName):
  ...
  # # item_path_major = f"/home/mutant_result_faulty_file_major/{pid}/{vid}b/muInfo.json"
  # item_path_major = f"/home/mutant_result_faulty_file_major/{pid}/{vid}b/mutantInfo.json"
  ...
  for item in mutant_result_json:
    ...
    item_path = f"/home/mutantFaultyFile/{pid}/{pid.lower()}_{vid}_buggy/{'/'.join(item[:-5].split('-')[:-1])}"
  ...
  # myfile = '/home/susMaxMbertMutantInfo/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxMajorMutantInfo/' + pid + '/' + vid + 'b'
  # myfile = '/home/MaxMajorKillJuzhen/' + pid + '/' + vid + 'b'
  # myfile = '/home/MaxMbertKillJuzhen/' + pid + '/' + vid + 'b'
  # 将排序后的字典写入csv文件,选择对应的文件
  # myfile = '/home/susMaxMbertHebingType1/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxSubAvgMbertType1/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxSubAvgMbertType3/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxSubAvgMbertType4/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxSubAvgMajorType1/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxSubAvgMajorType3/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxSubAvgMajorType4/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxMbertType1/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxMbertType3/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxMbertType4/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxMajorType1/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxMajorType3/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxMajorType4/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxSFCluShanjian/' + pid + '/' + vid + 'b'
  # myfile = '/home/susMaxSFClu/' + pid + '/' + vid + 'b'
  mp = {
      'susMaxMajorType3': 'Major',
      'susMaxMbertType3': 'Mbert'
  }
  # 获取杀死矩阵
  # killJuzhenFile = f'/home/MaxMajorKillJuzhen/{pid}/{vid}b'
  # # killJuzhenFile = f'/home/MaxMbertKillJuzhen/{pid}/{vid}b'
  ...
  # with open(f"/home/MaxMajorKillJuzhen/{pid}/{vid}b/mapmajor.json", 'w') as f:
  #   json.dump(mapmajor, f)
  # return

  # 获取每个变异体的怀疑度
  # AllMutantSusFile = f'/home/All{mp[susName]}MutantSus/{pid}/{vid}b'
  ...
  # 处理变异算子
  # mutantInfoFile = f'/home/susMaxMajorMutantInfo/{pid}/{vid}b'
  # # mutantInfoFile = f'/home/susMaxMbertMutantInfo/{pid}/{vid}b'
...
def start(pid, svid, evid, name, susName):
   for i in range(svid, evid + 1):
      ...
      # if i in list_ignore:
      #    continue
      init(f'/home/d4jbasecover/{pid}/{i}b', f'/home/d4jclean/{pid}/{i}b', f'/home/{name}/{pid}/{i}b', str(i), pid, susName)
      
      # init('/home/d4jbasecover/' + pid + '/' + str(i) + 'b', '/home/d4jclean/' + pid + '/' + str(i) + 'b', '/home/mutant_result_faulty_file_major_json/' + pid + '/' + str(i) + 'b', str(i), pid)
...
if __name__ == '__main__':
  ...
  #  chushihua('mutant_result_faulty_file_SFClu_json')
    ...
    # for i in range(svid, evid + 1):
      ...
      # if i in list_ignore:
      #    continue
      # init('/home/d4jbasecover/' + pid + '/' + str(i) + 'b', '/home/d4jclean/' + pid + '/' + str(i) + 'b', '/home/mutant_result_faulty_file_json/' + pid + '/' + str(i) + 'b', str(i), pid)
